          ...
          <div className="bg-color-primary w-[20rem] rounded-2xl shadow-xl p-4">
            <div className="w-full h-full">
              ...
              <p className="text-xs font-normal mt-2">
                ...
                button payment, and yeah you can select payment method for
                payments, and then yeah. Happy Shopping!!!
              </p>
              <p className="text-md font-bold mt-2 text-color-main">
                I Want Buy in High Production
              </p>
              <p className="text-xs font-normal">
                You can do that with the permission, you can request with
              ...
              <p className="text-xs font-normal">
                Okay you can explain your problems and please dont break
                anything in my product you must take a photo and video for your
                return product, you can request with contact example@email.com
              </p>
            </div>
          </div>
        </div>
      ...
      {payHistory && (
        ...
        >
          <div className="bg-color-primary w-[20rem] rounded-2xl shadow-xl p-4">
            <div className="w-full h-full">
              <div className="flex justify-between items-center">
                <p className="font-bold text-color-main text-lg">Pay Now</p>
                <X
                  size={18}
                  weight="bold"
                  className="cursor-pointer"
              ...
              <div className="w-full bg-color-gray shadow-inner font-normal mt-2 rounded-md p-3 min-h-16 flex flex-col gap-3 ">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center justify-center gap-0.5">
                    ...
                    <p className="opacity-50 ml-0.5 font-semibold text-xs">
                      x1
                    </p>
                  </div>
      ...
      {shipHistory && (
        ...
        >
          <div className="bg-color-primary w-[20rem] rounded-2xl shadow-xl p-4">
            <div className="w-full h-full">
              <div className="flex justify-between items-center">
                <p className="font-bold text-color-main text-lg">Your Ship</p>
                <X
                  size={18}
                  weight="bold"
                  className="cursor-pointer"
