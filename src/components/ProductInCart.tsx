    ...
    <>
      <div className="flex flex-col gap-4 rounded-xl overflow-y-auto hidden-scrollbar">
        {theProduct.data.slice(0, 6).map((cb, i) => {
          const [sudahDihapus,setSudahDihapus] = useState(false)
          const handleCloose = () => {
          ...
          return (
            <div key={i}  className={` ${sudahDihapus ?"hidden":"flex"} gap-4 items-center`}>
              <img
                src={cb.imageUrl}
